                  ...
                  <div className="divide-y divide-slate-50 relative min-h-[200px]">
                     ...
                     {tickets.length === 0 ? (
                        ...
                        tickets.slice(0, 5).map(t => (
                           <div key={t._id} className="p-6 hover:bg-slate-50 transition-all flex items-center justify-between group cursor-pointer">
                              <div className="flex items-center gap-4">
                                 <div className="w-10 h-10 bg-indigo-50 text-indigo-600 rounded-xl flex items-center justify-center font-black text-[10px]">#{t._id.slice(-4).toUpperCase()}</div>
                                 <div>
