 ...
 */
export async function callBackendAPI(endpoint: string, data?: any, method: 'GET' | 'POST' | 'PUT' | 'DELETE' | 'PATCH' = 'POST') {
    // 🔍 Log request details
...
export const apiClient = {
    ...
    patch: async (endpoint: string, body?: any) => {
        const data = await callBackendAPI(`/api${endpoint}`, body, 'PATCH');
        return { data };
    }
};